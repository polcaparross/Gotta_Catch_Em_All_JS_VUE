<template>
    <div id="playerAndHighGrassWrapper">
        ...
        <!-- <div v-if="inGrass" id="highGrass" style="height: 64px; width: 64px; bottom: calc(50% - 32px); left: calc(50% - 32px);"></div> -->
    </div>
</template>
...
#highGrass {
    ...
    background-image: url(/src/assets/map/high_grass_transparent.png);
